disease_dic = {
    ...
    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """ <b>Crop</b>: Corn <br/>Disease: Grey Leaf Spot<br/>
        <br/> Cause of disease:
        <br/><br/> Gray leaf spot lesions on corn leaves hinder photosynthetic activity, reducing carbohydrates allocated towards grain fill. The extent to which gray leaf spot damages crop yields can be estimated based on the extent to which leaves are infected relative to grain fill. Damage can be more severe when developing lesions progress past the ear leaf around pollination time. Because a decrease in functioning leaf area limits photosynthates dedicated towards grain fill, the plant might mobilize more carbohydrates from the stalk to fill kernels.
        <br/><br/> How to prevent/cure the disease <br/>
    ...
    'Grape___Black_rot': """ <b>Crop</b>: Grape <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:
        <br/><br/> 1. The black rot fungus overwinters in canes, tendrils, and leaves on the grapevine and on the ground. Mummified berries on the ground or those that are still clinging to the vines become the major infection source the following spring.
        ...
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. Space vines properly and choose a planting site where the vines will be exposed to full sun and good air circulation. Keep the vines off the ground and ensure they are properly tied, limiting the amount of time the vines remain wet thus reducing infection.
    ...
    'Soybean___healthy': """ <b>Crop</b>: Soybean <br/>Disease: No disease<br/>
        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",
    ...
    'Potato___Early_blight': """ <b>Crop</b>: Potato <br/>Disease: Early Blight<br/>
        ...
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. Plant only disease-free, certified seed.
    ...
    'Strawberry___Leaf_scorch': """ <b>Crop</b>: Strawberry <br/>Disease: Leaf Scorch<br/>
        ...
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. Since this fungal pathogen overwinters on the fallen leaves of infected plants, proper garden sanitation is key.
